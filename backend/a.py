index = {
    ...
    "102": {
        ...
        "properties": [
            ...
            [
                { "type": "SpeedAddedRatio", "value": 0.06 }
            ]
        ],
    ...
    "103": {
        ...
        "properties": [
            [
                { "type": "DefenceAddedRatio", "value": 0.15 }
            ],
            []
        ],
    ...
    "105": {
        ...
        "properties": [
            [
                { "type": "PhysicalAddedRatio", "value": 0.1 }
            ],
            []
        ],
    ...
    "108": {
        ...
        "properties": [
            [
                { "type": "QuantumAddedRatio", "value": 0.1 }
            ],
            []
        ],
    ...
    "109": {
        ...
        "properties": [
            [
                { "type": "ThunderAddedRatio", "value": 0.1 }
            ],
            []
        ],
    ...
    "112": {
        ...
        "properties": [
            [
                { "type": "ImaginaryAddedRatio", "value": 0.1 }
            ],
            []
        ],
    ...
    "117": {
        ...
        "properties": [
            [],
            [
                { "type": "CriticalChanceBase", "value": 0.04 }
            ]
        ],
    ...
    "120": {
        ...
        "properties": [
            ...
            [
                { "type": "CriticalChanceBase", "value": 0.06 }
            ]
        ],
    ...
    "124": {
        ...
        "properties": [
            ...
            [
                { "type": "SpeedAddedRatio", "value": -0.08 }
            ]
        ],
    ...
    "303": {
        ...
        "properties": [
            [
                { "type": "StatusProbabilityBase", "value": 0.1 }
            ]
        ],
    ...
    "305": {
        ...
        "properties": [
            [
                { "type": "CriticalDamageBase", "value": 0.16 }
            ]
        ],
...
for (key, value) in index.items():
    if "properties" in value:
        for i in range(len(value["properties"])):
            for j in range(len(value["properties"][i])):
                if "value" in value["properties"][i][j]:
                    # print(f"{key}: {value['properties'][i][j]['type']} = {value['properties'][i][j]['value']} | {value['id']} || {i}")
                    print(f"{key}_{i*2+2};{value['properties'][i][j]['type']};{value['properties'][i][j]['value']}")
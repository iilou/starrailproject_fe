export default function SubHeader({ text, width }: { text: string; width?: string }) {
  return (
    <div
      ...
      className={`h-[50px] text-center bg-[#3d3b8a] text-[#f4e135] mx-auto mt-3 relative z-[100]`}
      style={{ textShadow: "0 0 5px #000, 0 0 10px #000, 0 0 15px #000, 0 0 20px #000, 0 0 5px #f4e135", width: width }}>
      <div
